...
public class AlienDictionary {
    ...
    public String foreignDictionary(String[] words) {
        ...
        System.out.println(" adjacent map :::: "+adj);
        ...
        System.out.println(" adjacent map after modification :::: "+adj);
    ...
    public static void main(String[] args) {
    	...
    	String[] st = {"hrn","hrf","er","enn","rfnn"};
    	System.out.println(" word form :::: "+adic.foreignDictionary(st));
